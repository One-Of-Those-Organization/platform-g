...
function M.preload(shaders)
    ...
    M.deskTexture = love.graphics.newImage("assets/desk_texture.jpg")
    ...
    M.desk = {
        {desk_perspective,      ch - ch/2.5,  0,        0},
        {cw - desk_perspective, ch - ch/2.5,  repeatX,  0},
